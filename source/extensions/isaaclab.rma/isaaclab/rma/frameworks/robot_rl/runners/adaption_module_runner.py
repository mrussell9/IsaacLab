...
from isaaclab.rma.frameworks.robot_rl.algorithms import PPO, BC
            ...
            with torch.inference_mode():
                for i in range(self.num_steps_per_env):
                    ...
                    if "teacher" in infos["observations"]:
                        ...
                        teacher_obs = obs
                    obs, critic_obs, teacher_obs, rewards, dones = (
                        obs.to(self.device),
                        critic_obs.to(self.device),
                        teacher_obs.to(self.device),
    ...
    def log(self, locs: dict, width: int = 80, pad: int = 35):
        ...
        if len(locs["rewbuffer"]) > 0:
            log_string = (
                ...
                f"""{'Mean Squared Error loss:':>{pad}} {locs['mse_loss']:.4f}\n"""
